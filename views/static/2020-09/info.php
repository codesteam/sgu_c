    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="alert alert-info">
                Уважаемые коллеги! На данный момент в VI Межрегиональной научно-практической конференции "Перспективные направления развития отечественных информационных технологий" подтвердили свое участие более 210 человек (около 190 устных и стендовых докладов). Среди 124 устных докладов 62 подготовлены по результатам реализации проектов, поддержанных РФФИ.
                <!-- <br/>
                <br/> -->
  <!--               <strong>
                    <a href="/assets_app/files/2020-09/reports.pdf">Список основных докладов ПНРОИТ-2020</a>
                </strong> -->
                <br/>
                <br/>
                <strong>
                    <a href="/assets_app/files/2020-09/program.pdf">Программа конференции</a>
                </strong>
            </div>
            <p>
