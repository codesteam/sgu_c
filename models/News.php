        ...
        return [
            [
                ...
                'text' => '
                    ...
                    <p>
                        Программный комитет конференции принял решение продлить срок  подачи заявок участников Конференции и материалов докладов для включения в сборник тезисов до <strong>31 июля 2021</strong>.
                    </p>
            '],
            [
                'date' => '2 июля 2021',
                'text' => '
                    <p>
                        ...
                        <ul>
                            <li><a href="/assets_app/files/2021-09/pnroit-2021.pdf">Информационное письмо</a><br/></li>
                         </ul>
                    </p>
            '],
            [
                ...
                'text' => '
                    ...
                    <p>
                        Торжественное открытие VI Межрегиональной научно-практической конференции «Перспективные направления развития отечественных информационных технологий» и первое пленарное заседание состоятся 23 сентября 2020 г. в 10:00 часов в Севастопольском государственном университете по адресу: 299053, г. Севастополь, ул. Университетская, 33, аудитория 420 «Севастополь».
                    </p>
                    <p>Регистрация участников с 09:00  23 сентября 2020 г. (сектор Д, ауд. 420 "Севастополь").</p>
                        <ul>
            ...
            [
                ...
                'text' => '
                    <p>
                        Информация о конференции:
                        <ul>
                            <li><a href="/assets_app/files/2020-09/pnroit-2020.pdf">Информационное письмо</a><br/></li>
                         </ul>
                    </p>
            '],
            [
            ...
            [
                ...
                'text' => '
                    <p>
                        <p>Информация о конференции:</p>
                        <p>
                            Просим обратить ваше внимание на <a href="/assets_app/files/2018-09/requisites.doc">реквизиты для оплаты</a>. Не забудьте проверить назначение платежа.
                        </p>
                        <p>С уважением, Оргкомитет конференции.</p>
                    </p>
            '],
            [
                ...
                'text' => '
                    <p>
                        <p>Информация о конференции:</p>
                        <p><a href="/assets_app/files/2019-09/organizers.pdf">Программный комитет конференции</a></p>
                        <p><a href="/assets_app/files/2019-09/program.pdf">
                            Предварительная научная программа V Межрегиональной научно-практической конференции "Перспективные направления развития отечественных информационных технологий", 24-28 сентября 2019. г. Севастополь</a></p>
                        <p>С уважением, Оргкомитет конференции.</p>
                    </p>
            '],
            [
            ...
            [
                ...
                'text' => '
                    <p>
                        <p class="text-center"><img src="/assets_app/images/program-2018.png" /></p>
                        <p>Информация о конференции:</p>
